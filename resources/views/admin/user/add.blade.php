...
@section('breadcrumb')
	<a href="{{ url('/admin-list') }}">Admin List</a>
@endsection
...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="m-portlet">
			...
			<!--begin::Form-->
			<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="add_admin" method="post" action="{{ url('add-admin') }}" enctype="multipart/form-data">
				@csrf
