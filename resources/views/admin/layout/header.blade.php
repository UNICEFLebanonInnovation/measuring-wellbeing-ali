				...
				<div class="m-stack m-stack--ver m-stack--general">
					<div class="m-stack__item m-stack__item--middle m-brand__logo">
						<a href="{{ url('/') }}" class="m-brand__logo-wrapper">
							<img style="margin-top:10px;" src="{{ url('/public') }}/images/inter-agency-web-small.JPG" height="80px" width="180px" />
						</a>
					</div>
					...
					<div class="m-stack__item m-topbar__nav-wrapper">
						<ul class="m-topbar__nav m-nav m-nav--inline">
												...
												<div class="m-scrollable" data-scrollable="false" data-height="380" data-mobile-height="200">
													<div class="m-nav-grid m-nav-grid--skin-light">
														<div class="m-nav-grid__row">
															<a href="{{ url('locale/en') }}" class="m-nav-grid__item">
																<span class="m-nav-grid__text">English</span>
															</a>
															<a href="{{ url('locale/ar') }}" class="m-nav-grid__item">
							...
							<li class="m-nav__item m-topbar__user-profile  m-dropdown m-dropdown--medium m-dropdown--arrow  m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
								<a href="javascript:;" class="m-nav__link m-dropdown__toggle">
									<span class="m-topbar__userpic">{{ ucfirst(Auth::user()->firstname) }}
									...
									<span class="m-topbar__username m--hide">{{ ucfirst(Auth::user()->firstname) }}</span>
								</a>
								<div class="m-dropdown__wrapper">
									<span class="m-dropdown__arrow m-dropdown__arrow--right m-dropdown__arrow--adjust"></span>
									<div class="m-dropdown__inner">
										<div class="m-dropdown__header m--align-center">
											<div class="m-card-user m-card-user--skin-light">
												{{-- <div class="m-card-user__pic">
													<img src="{{ url('/public') }}/assets/app/media/img/users/user4.jpg" class="m--img-rounded m--marginless" alt="" />
												</div> --}}
												<div class="m-card-user__details">
													<span class="m-card-user__name m--font-weight-500">{{ ucfirst(Auth::user()->firstname)." ".ucfirst(Auth::user()->lastname) }}</span>
