...
@section('title',"Govornorate Analysys")

@section('breadcrumb')
	<a href="{{ url('/analytics') }}">Govornorate Analysis</a>
@endsection
...
<script type="text/javascript">
	...
	am4core.useTheme(am4themes_animated);
		...
		$.post('{{route('load-gov-analysys')}}',{_token:"{{ csrf_token() }}",gender_com_gov:gender_com_gov,nationality_com_gov:nationality_com_gov,age_com_gov:age_com_gov,gender_com_partner:gender_com_partner},function(response){
		...
		$.post('{{route('load-gov-analysys1')}}',{_token:"{{ csrf_token() }}",gender_mean_des_gov:gender_mean_des_gov,nationality_mean_des_gov:nationality_mean_des_gov,age_mean_des_gov:age_mean_des_gov,partner_mean_des_gov:partner_mean_des_gov},function(response){
			res = JSON.parse(response);
		 	chart1.data = res;
		...
		// $.post('{{route('load-gov-analysys1')}}',{age:"Form 6-11",_token:"{{ csrf_token() }}"},function(response){
		// 	res = JSON.parse(response);
		//  	chart2.data = res;
		...
		// $.post('{{route('load-gov-analysys1')}}',{age:"Form 12-17",_token:"{{ csrf_token() }}"},function(response){
		// 	res = JSON.parse(response);
		//  	chart3.data = res;
