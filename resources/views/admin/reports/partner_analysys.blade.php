...
@section('title',$title." Analysys")

@section('breadcrumb')
	<a href="{{ url('/analytics') }}">{{ $title }} Analysis</a>
@endsection
...
<script type="text/javascript">
	...
	am4core.useTheme(am4themes_animated);
		...
		// Add data
		$.post('{{route('load-partner-analysys')}}',{_token:"{{ csrf_token() }}",gender:gender,form_filter:form_filter,nationlity_filter:nationlity_filter,partner_filter:partner_filter},function(response){
		...
		$.post('{{route('load-partner-analysys1')}}',{_token:"{{ csrf_token() }}",gender:gender,form_filter:form_filter,nationlity_filter:nationlity_filter,partner_filter:partner_filter},function(response){
			res = JSON.parse(response);
			chart1.data = res;
