...
@section('breadcrumb')
	<a href="{{ url('status-list') }}">Add Status</a>
@endsection
...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="m-portlet">
			...
			<!--begin::Form-->
			<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="add_status" action="{{ url('add-status') }}" method="post">
				@csrf
				<div class="m-portlet__body">
					<div class="form-group m-form__group row">
						<div class="col-lg-6">
							<label>Status Name:</label>
							<input type="text" class="form-control m-input" value="{{ old('name') }}" id="name" name="name" placeholder="Enter Status name">
							@if ($errors->has('name'))
