<?php $__env->startSection('title',"Normal Comparison"); ?>

<?php $__env->startSection('breadcrumb'); ?>
	<a href="<?php echo e(url('/analytics')); ?>">Normal Comparison</a>
...
function load_partner_dropout_chart(gender,form_filter,category_filter,nationlity_filter,governorate_filter,partner_filter)
		...
		// Add data
		$.post('<?php echo e(route('load-normal-conparison')); ?>',{_token:"<?php echo e(csrf_token()); ?>",gender:gender,form_filter:form_filter,category_filter:category_filter,nationlity_filter:nationlity_filter,governorate_filter:governorate_filter,partner_filter:partner_filter},function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hqpyj8xflnii/public_html/prod/resources/views/admin/reports/normal_comparision.blade.php ENDPATH**/ ?>