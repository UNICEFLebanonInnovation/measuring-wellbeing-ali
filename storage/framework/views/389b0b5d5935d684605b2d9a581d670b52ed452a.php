<?php $__env->startSection('title',"Analysys Change"); ?>

<?php $__env->startSection('breadcrumb'); ?>
<a href="<?php echo e(url('/analytics')); ?>">Analysis Change</a>
			...
			<ul class="m-portlet__nav">
				...
				<li class="m-portlet__nav-item">
					...
					<select class="form-control m-input service_filter" id="service_filter" name="service_filter">
						...
						<option value="Case management"><?php echo e(trans('messages.case_management')); ?></option>
						<option value="Community based Child protection activities"><?php echo e(trans('messages.community_based_child_protection_activities')); ?></option>
						<option value="Formal Education"><?php echo e(trans('messages.formal_education')); ?></option>
						<option value="Non-formal education (VET programs…)"><?php echo e(trans('messages.non_formal_education')); ?></option>
						<option value="No"><?php echo e(trans('messages.no')); ?></option>
					</select>
				</li>
			</ul>
		</div>
...
<script type="text/javascript">
	...
	function load_partner_dropout_chart(gender,form_filter,category_filter,nationlity_filter,governorate_filter,partner_filter,service_filter)
	{
		...
		// Add data
		$.post('<?php echo e(route('load-analysis-change')); ?>',{_token:"<?php echo e(csrf_token()); ?>",gender:gender,form_filter:form_filter,category_filter:category_filter,nationlity_filter:nationlity_filter,governorate_filter:governorate_filter,partner_filter:partner_filter,service_filter:service_filter},function(response){
		...
		$.post('<?php echo e(route('load-analysis-change1')); ?>',{_token:"<?php echo e(csrf_token()); ?>","age":"Form 6-11","gender":"male"},function(response){
		...
		$.post('<?php echo e(route('load-analysis-change1')); ?>',{_token:"<?php echo e(csrf_token()); ?>","age":"Form 12-17","gender":"male"},function(response){
		...
		$.post('<?php echo e(route('load-analysis-change1')); ?>',{_token:"<?php echo e(csrf_token()); ?>","age":"Form 6-11","gender":"female"},function(response){
		...
		$.post('<?php echo e(route('load-analysis-change1')); ?>',{_token:"<?php echo e(csrf_token()); ?>","age":"Form 12-17","gender":"female"},function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hqpyj8xflnii/public_html/prod/resources/views/admin/reports/analysis_change.blade.php ENDPATH**/ ?>