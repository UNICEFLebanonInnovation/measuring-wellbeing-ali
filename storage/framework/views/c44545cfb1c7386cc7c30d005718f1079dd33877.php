...
<div style="width: 600px; margin:auto; background-color: #F7F7F7; padding-bottom: 30px; border-top-left-radius: 10px; border-top-right-radius: 10px; box-shadow: 0px 0px 10px 1px #00000021; margin-bottom: 30px;">
    ...
    <div style="padding-left: 30px; padding-right: 30px; padding-top: 30px; text-align: center;">
        <div style="font-size: 19px;color: #707070;line-height: 120%;margin-bottom: 30px;">
            Hey <span style="color: #2e2e2e;"><?php echo e(ucfirst($receiver)); ?></span>, Please click on below button to setup your profile and passowrd
        </div>
        <div style="width:290px; margin: auto;">
            <a href="<?php echo e(url('setup-profile/'.$data['token_key'])); ?>" style="font-size: 16px;text-transform: uppercase;letter-spacing: 1px;padding: 10px 0px;background: #73879C;text-decoration: none; color: #fff;border-radius: 5px;cursor: pointer;display: block;">
               Setup Profile
        </a>
    </div>
...
<?php echo $__env->make('emails.common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hqpyj8xflnii/public_html/prod/resources/views/emails/setup_profile.blade.php ENDPATH**/ ?>